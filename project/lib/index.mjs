...
var p = (r, o, e) => o in r ? d(r, o, { enumerable: !0, configurable: !0, writable: !0, value: e }) : r[o] = e;
var f = (r, o, e) => (p(r, typeof o != "symbol" ? o + "" : o, e), e);
import { property as h, customElement as m, QuarkElement as n, Fragment as g } from "quarkc";
function u(r, o, e, l) {
  var a = arguments.length, t = a < 3 ? o : l === null ? l = Object.getOwnPropertyDescriptor(o, e) : l, i;
...
let c = class extends n {
  ...
  render() {
    return n.h(g, null, n.h("div", null, n.h("a", {
      ...
      class: "logo",
      alt: "quark logo"
    }))), n.h("h1", null, "Quark - 为跨技术栈而生"), this.atitle, n.h("div", {
      className: "card"
    }, n.h("button", {
      onClick: this.add
    }, "count is: ", this.count)));
